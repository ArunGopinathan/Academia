package edu.uta.cse.academia.Adapters;
...
public class ServicesListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void createServiceRow(ViewHolder holder, int position){
       ...
       // holder.courseListCircle.getBackground().setColorFilter(Color.parseColor(randomAndroidColor), PorterDuff.Mode.DARKEN);
        GradientDrawable gd = (GradientDrawable) holder.courseListCircle.getBackground();
        gd.setColor(randomAndroidColor);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            courseListCircle = (ImageView) itemView.findViewById(R.id.course_list_item_iv_circle);
