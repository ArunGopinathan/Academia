...
public class RegisterServiceRequestObject
{
    ...
    private edu.uta.cse.academia.Models.Category Category;

    private edu.uta.cse.academia.Models.Availability Availability;

    private edu.uta.cse.academia.Models.SubCategory SubCategory;
